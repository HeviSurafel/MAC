  ...
  return(
    ...
    <div className="flex items-center space-x-4">
      ...
      <div>
        ...
        <div className="text-sm text-gray-500 uppercase">{user.role === "student" ? "STUDENT" : "INSTRACTOR" +"\t" } {user.name}</div>
        <div className="text-sm text-gray-500 uppercase">{user.address}</div>
      </div>
    </div>
    <button
