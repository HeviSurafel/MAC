    ...
    <div className="bg-gray-50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 animate__animated animate__fadeIn animate__delay-2s">
              We are passionate about delivering innovative solutions and
      ...
      <section className="py-20 px-6 text-center">
        ...
        <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-12">
          Our mission is to bring innovative and effective solutions to our
          clients, helping them succeed in their goals while ensuring that we
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="transform transition duration-300 hover:scale-105 hover:shadow-xl p-6 bg-white rounded-lg shadow-lg">
            ...
            <p className="text-gray-600">
              We believe in the power of innovative ideas to drive growth and
              change in every industry we touch.
            </p>
          </div>
          <div className="transform transition duration-300 hover:scale-105 hover:shadow-xl p-6 bg-white rounded-lg shadow-lg">
            ...
            <p className="text-gray-600">
              Our top priority is ensuring that our customers succeed, by
              providing top-tier service and support tailored to their needs.
            </p>
          </div>
          <div className="transform transition duration-300 hover:scale-105 hover:shadow-xl p-6 bg-white rounded-lg shadow-lg">
            ...
            <p className="text-gray-600">
              We are committed to delivering exceptional results, maintaining
              ...
              <div className="relative z-10 animate__animated animate__fadeIn animate__delay-1s">
                <div className="flex flex-col sm:flex-row items-center justify-center mb-6">
                  ...
                  <div className="flex-1 text-gray-700">
                    ...
                    <p className="text-gray-600">
                      We started our journey with a passion for innovation and
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center mb-6">
                  ...
                  <div className="flex-1 text-gray-700">
                    ...
                    <p className="text-gray-600">
                      Completed our first large-scale project, exceeding client
                      expectations.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col sm:flex-row items-center justify-center mb-6">
                  ...
                  <div className="flex-1 text-gray-700">
                    ...
                    <p className="text-gray-600">
                      Launched our services in three additional countries,
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-xl transform transition duration-500 hover:scale-105 hover:shadow-2xl">
            ...
            <p className="text-gray-700">
              John is the visionary behind our company, driving growth and
              innovation.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-xl transform transition duration-500 hover:scale-105 hover:shadow-2xl">
            ...
            <p className="text-gray-700">
              Jane’s designs create the seamless user experience our clients
              love.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-xl transform transition duration-500 hover:scale-105 hover:shadow-2xl">
            ...
            <p className="text-gray-700">
              Mark ensures that our products are not only functional but
      ...
      <section className="bg-indigo-600 text-white py-20 text-center">
        ...
        <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto">
          ...
          you're ready to make an impact, let's connect.
        </p>
